  ...
  return (
    ...
    >
      ...
      >
        ...
        <div></div>
        <div>{/* <TermTextToSpeech></TermTextToSpeech> */}</div>
        <section className="text-justify">
          <div className="my-5">
            ...
            <p>
              Duolingo websites (“Websites”) and mobile applications (“Apps”)
              and related services (together with the Websites, the “Service”)
              are operated by Duolingo, Inc. (“Duolingo,” “us,” or “we”). Access
              and use of the Service is subject to the following Terms and
              Conditions of Service (“Terms and Conditions”). By accessing or
              using any part of the Service, you represent that you have read,
              understood, and agree to be bound by these Terms and Conditions
              including any future modifications. Duolingo may amend, update or
              change these Terms and Conditions. If we do this, we will post a
              notice that we have made changes to these Terms and Conditions on
              the Websites for at least 7 days after the changes are posted and
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              4. <strong className="font-semibold">Additional Terms</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
          ...
          <div className="my-5">
            ...
            <div className="text-2xl text-gray-500 pl-5">
              ...
              <p className="py-5">
                ...
                about you and/or your organization as requested by Duolingo;
                ...
                and complete; and (iv) to be fully responsible for all use of
                your account and for any actions that take place through your
                account.
              </p>
              <small>
                <i>
                  <u>b. Course Contributor Submissions</u>
                </i>
              </small>
              <p className="py-5">
                ...
                Service, as agreed between you and Duolingo on a case-by-case
                basis. Subject to any guidelines posted on the Service, you may
                perform any such translations or create any such courses in
                accordance with your own schedule and using your own facilities
                and resources. You are not required to become a Course
                Contributor and you may cease your activities as a Course
                Contributor at any time. You acknowledge that you do not desire
                and will not receive compensation for your activities as a
                Course Contributor or for our use of any Course Contributor
                Materials (as defined below) you submit. Any translation of an
                existing Duolingo course you submit or have submitted and any
                new language course you submit or have submitted as a Course
                Contributor (collectively, “Course Contributor Materials”) are
                owned by you (subject of course to us retaining ownership of the
                existing Duolingo course you translated).
              </p>
              <small>
                <i>
                  <u>c. General Content</u>
                </i>
              </small>
              <p className="py-5">
                As a condition of submitting any ratings, reviews, information,
                data, text, photographs, audio clips, audiovisual works,
                translations, flashcards, Course Contributor Material, or other
                materials on the Services (collectively, “Content”), be $10,000
                or less, either you or Duolingo may elect to have the dispute
                resolved through non-appearance-based arbitration. you hereby
                grant to Duolingo a full- paid, royalty free, perpetual,
                irrevocable, worldwide, nonexclusive, transferable, and
                sublicensable license to use, reproduce, copy, adapt, modify,
                merge, distribute, publicly display, create derivative works
                from, incorporate such Content into other works; sublicense
                through multiple tiers the Content, and acknowledge that this
                license cannot be terminated by you once your Content is
                submitted to the Services. You represent that you own or have
                secured all legal rights necessary for the Content submitted by
                you to be used by you, Duolingo, and others as described and
                otherwise contemplated in these Terms and Conditions. You
                understand that other users will have access to the Content and
                that neither they or Duolingo have any obligation to you or
                anyone else to maintain the confidentiality of the Content.
              </p>
            </div>
          </div>
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              material you submit via the Service (including Translation
              Materials, Course Contributor Materials, Activity Materials, and
              Content) and that you have the right, as applicable, to grant us a
              license to use that material as set forth above or the right to
              assign that material to us as set forth below.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              You represent and warrant that (1) you are not organized under the
              laws of, operating from, or otherwise ordinarily resident in a
              country or territory that is the target or comprehensive U.S.
              economic or trade sanctions (i.e., an embargo) or (2) identified
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              7. <strong className="font-semibold">Inappropriate Use</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              personal or proprietary rights); or (ii) in Duolingo’s sole
              judgment, is objectionable or which restricts or inhibits any
              other person from using the Service or which may expose Duolingo
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              9. <strong className="font-semibold">License to Apps</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              10. <strong className="font-semibold">In-App Purchases</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              Duolingo may manage, regulate, control, modify, or eliminate
              Virtual Items at any time, with or without notice. Duolingo may
              update the pricing of Virtual Items at any time in its sole
              discretion, and may add new Virtual Items for additional fees.
              Duolingo shall have no liability to you or any third party in the
              event that Duolingo exercises any such rights.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              the Service, you shall not sell, redeem or otherwise transfer
              Virtual Items to any person or entity, including but not limited
              to Company, another user, or any third party.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              You agree to pay all fees and applicable taxes incurred by you or
              anyone using a Duolingo account registered to you. Duolingo may
              revise the pricing for the goods and services offered through the
              Service at any time. All information that you provide in
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              11. <strong className="font-semibold">Payment Processors</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              All financial transactions made in connection with the Service
              will be processed by a third party in accordance with their
              respective terms of use, privacy policy, and/or any applicable
              payment terms and conditions. We encourage you to learn about the
              practices of such third party. In no event will Duolingo be
              responsible for the actions or inactions of any third party
              payment processor, including, but not limited to, system downtime
              or payment service outages.
            </p>
          </div>
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              12. <strong className="font-semibold">Refund Policy</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              In the event that Duolingo suspends or terminates your use of the
              Service or these Terms and Conditions or you close your account
              voluntarily, you understand and agree that you will receive no
              refund or exchange of any kind, including for any unused virtual
              currency or other Virtual Item, any Content or data associated
          ...
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              activities that are not owned or controlled by Duolingo. We do not
              endorse or assume any responsibility for any such third-party
              sites, information, materials, products, or services. If you
              access any third party website, service, or content from Duolingo,
              ...
              acknowledge and agree that Duolingo shall not be responsible or
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              The types and extent of advertising by Duolingo on the Service are
              subject to change. In consideration for Duolingo granting you
              access to and use of the Service, you agree that Duolingo and its
          ...
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              PROVIDED TO YOU BY DUOLINGO ARE PROVIDED TO YOU ON AN “AS IS”
              BASIS. DUOLINGO AND ITS SUPPLIERS MAKE NO REPRESENTATIONS OR
              ...
              GENERALITY OF THE FOREGOING, DUOLINGO DOES NOT MAKE ANY
          ...
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              WILL DUOLINGO BE LIABLE TO YOU OR ANY THIRD PARTY CLAIMING THROUGH
              YOU (WHETHER BASED IN CONTRACT, TORT, STRICT LIABILITY OR OTHER
              THEORY) FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR
              EXEMPLARY DAMAGES ARISING OUT OF OR RELATING TO THE ACCESS OR USE
              OF, OR THE INABILITY TO ACCESS OR USE, THE SERVICE OR ANY PORTION
              THEREOF, INCLUDING BUT NOT LIMITED TO THE LOSS OF USE OF THE
              SERVICE, INACCURATE RESULTS, LOSS OF PROFITS, BUSINESS
              INTERRUPTION, OR DAMAGES STEMMING FROM LOSS OR CORRUPTION OF DATA
              OR DATA BEING RENDERED INACCURATE, THE COST OF RECOVERING ANY
              DATA, THE COST OF SUBSTITUTE SERVICES OR CLAIMS BY THIRD PARTIES
              FOR ANY DAMAGE TO COMPUTERS, SOFTWARE, MODEMS, TELEPHONES OR OTHER
              PROPERTY, EVEN IF DUOLINGO HAS BEEN ADVISED OF THE POSSIBILITY OF
              SUCH DAMAGES. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW,
              DUOLINGO’S LIABILITY TO YOU OR ANY THIRD PARTY CLAIMING THROUGH
              YOU FOR ANY CAUSE WHATSOEVER, AND REGARDLESS OF THE FORM OF THE
              ACTION, IS LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO DUOLINGO
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              into these Terms and Conditions with you in reliance upon the
              limitations of liability set forth in these Terms and Conditions,
              which allocate risk between us and form the basis of a bargain
              between the parties.
            </p>
          </div>
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              16. <strong className="font-semibold">Termination</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              Duolingo may terminate your access and use of the Service
              ...
              Duolingo account at any time by following the instructions
              available through the Service. The provisions of these Terms and
              Conditions relating to the protection and enforcement of
              Duolingo’s proprietary rights, your representations and
          ...
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              files, and their selection and arrangement (the Service Content),
              are the proprietary property of Duolingo or its licensors. No
              ...
              Content. As between you and Duolingo, all data, information and
              materials generated from your access and use of the educational
              ...
              Materials”), shall be exclusively owned by Duolingo, and you shall
              not have any right to use such Activity Materials except as
              expressly authorized by these Terms and Conditions. Activity
              Materials will not include Translation Materials. By using the
              Service, you hereby assign to Duolingo any and all rights, title
              and interest, including any intellectual property rights or
              proprietary rights, in the Activity Materials. All rights of
              Duolingo or its licensors that are not expressly granted in these
              Terms and Conditions are reserved to Duolingo and its licensors.
            </p>
          </div>
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              18. <strong className="font-semibold">Trademarks</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              “Duolingo” and all other trademarks, service marks, graphics and
              logos used in connection with the Service are trademarks or
              service marks of Duolingo or their respective owners, and certain
              of them are registered with the United States Patent and Trademark
              Office. Access and use of the Service does not grant or provide
              you with the right or license to reproduce or otherwise use the
              Duolingo name or any Duolingo or third-party trademarks, service
              marks, graphics or logos.
            </p>
          </div>
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              19. <strong className="font-semibold">Privacy</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              Use of the Service is also governed by our Privacy Policy, a copy
              of which is located at{" "}
              <Link href="#">
                <u>www.duolingo.com/privacy</u>
              </Link>{" "}
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              20.{" "}
              <strong className="font-semibold">Promotion Code Terms</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              “Duolingo” and all other trademarks, service marks, graphics and
              logos used in connection with the Service are trademarks or
            ...
            <div className="text-2xl text-gray-500 pl-5">
              <small>
                <i>
                  <u>The Promotional Code.</u>
                </i>
              </small>
              <p className="py-5">
                Each Promotional Code provides access to Super Duolingo: A. at
                the price advertised; and B. beginning the moment that you
                confirm your acceptance of the Promotional Code by submitting
                valid payment details that are accepted by Duolingo (the
                “Promotional Period”); and C. in some circumstances, subject to
                an overall limit of allowed redemptions of that Promotional
                Code. By submitting your payment details, you (i) confirm your
                acceptance of the Promotional Code advertised; (ii) accept and
                agree to these Promotional Code Terms; and (iii) acknowledge and
              ...
              <p className="py-5">
                In order to be eligible for a Promotional Code, users must
                satisfy all of the following conditions (each an “Eligible
                User”): A. Unless you are subscribing to a Promotional Code that
                is advertised as available to current subscribers, you must not
                be a current subscriber. B. Provide Duolingo with a valid and
                current payment method that is approved by Duolingo. C.
                Additional eligibility requirements (if any) as advertised from
                time-to-time in connection with a Promotional Code. Eligible
                Users may accept a Promotional Code once - previous users may
              ...
              <p className="py-5">
                A Promotional Code must be accepted before the applicable
                expiration date advertised, if any. Except where prohibited by
                law, Duolingo reserves the right to modify, suspend or terminate
                a Promotional Code at any time and for any reason, in which case
                we will not honour subsequent Promotional Code enrollments.
              </p>
              <small>
                <i>
                  <u>Duration and cancellation.</u>
                </i>
              </small>
              <p className="py-5">
                Unless you cancel your subscription before the end of the
                Promotional Period, you will automatically become a recurring
                subscriber and your Super Duolingo subscription will continue to
                automatically renew for additional periods equal to the expiring
                subscription term, unless you cancel before the end of the
                relevant subscription term pursuant to Duolingo’s terms and
                conditions. The payment method you provided will automatically
                be charged for the then-current subscription price. If you
                cancel during the Promotional Period, you will lose access to
                Super Duolingo and you understand and agree that you will
                receive no refund or exchange of any kind, including for any
                unused virtual currency or other Virtual Item, any Content or
                data associated with your use of the Service, or for anything
                else.
              </p>
              <small>
                <i>
              ...
              <p className="py-5">
                By using the Promotional Code, you understand and agree that
                your anonymized aggregated data may be shared by Duolingo with
                the partner or provider who made the Promotional Code available
                to you.
              </p>
            </div>
          </div>
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              ...
              to Duolingo pursuant to the Digital Millennium Copyright Act by
            ...
            <div className="text-2xl text-gray-500 my-5 pl-5">
              ...
              <li>
                ...
                is located on the Service, with enough detail that we may find
                it on the Service;
              </li>
            ...
            <h3 className="text-2xl text-gray-500 my-5 pl-5">
              Please consult your legal counsel for further details or see 17
              U.S.C. §512(c)(3). Duolingo’s Agent for Notice of claims of
              copyright infringement can be reached as follows:
            </h3>
            <h3 className="text-2xl text-gray-500 my-5 pl-5">
              By mail: 5900 Penn Avenue, Pittsburgh PA 15206, USA By email:
              abuse@duolingo.com
            </h3>
            <h3 className="text-2xl text-gray-500 my-5 pl-5">
              For clarity, only copyright infringement notices should go to our
              Copyright Agent. You acknowledge that if you fail to comply with
              all of the requirements of this section your notice may not be
              valid.
            </h3>
            <h3 className="text-2xl text-gray-500 my-5 pl-5">
              If you believe the content that was removed (or to which access
              was disabled) is not infringing, or that you have the
              authorization from the copyright owner, the copyright owners
              agent, or pursuant to the law, to post and use such content, you
              may submit a counter-notice to the address listed above containing
            ...
            <div className="text-2xl text-gray-500 my-5 pl-5">
              ...
              <li>
                ...
                federal court in the judicial district in which you reside, or
                if you reside outside of the United States, then of the federal
                court in Pittsburgh, Pennsylvania, and a statement that you will
            ...
            <h3 className="text-2xl text-gray-500 my-5 pl-5">
              ...
              notify us within 10 days that he or she has filed an action
              seeking a court order to restrain you from engaging in infringing
              activity relating to the content that was removed or disabled. If
              we receive such notification, we will be unable to restore the
              material. If we do not receive such notification, we may reinstate
              the material.
            </h3>
          </div>
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              These Terms and Conditions, its subject matter and Duolingo’s and
              your respective rights under these Terms and Conditions, as well
              as and any claim, cause of action or dispute (“claim”) arising out
              of or related to these Terms and Conditions, shall be governed by
              and construed under the laws of the Commonwealth of Pennsylvania,
              United States of America, excluding the conflict of law provisions
              of that or any other jurisdiction, regardless of your country of
              origin or where you access the Service. ANY DISPUTE OR CLAIM
              RELATING IN ANY WAY TO THESE TERMS AND CONDITIONS OR THE SERVICE
              ...
              below. Unless otherwise expressly required by applicable law, each
              party shall bear its own attorneys’ fees without regard to which
              party is deemed the prevailing party in the arbitration
              proceeding.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              If you do not want to arbitrate disputes with Duolingo and you are
              an individual, you may opt out of this arbitration agreement by
              sending an email to legal@duolingo.com within 30 days of the day
              you first access or use the Service.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              If you intend to seek arbitration you must first send written
              notice to Duolingo’s Administration Office of your intent to
              arbitrate (“Notice”). The Notice to Duolingo should be sent by any
              of the following means: (i) electronic mail to legal@duolingo.com;
              or (ii) sending the Notice by U.S. Postal Service certified mail
              to Duolingo, Inc., Attention: Legal, 5900 Penn Ave; Pittsburgh, PA
              15206. The Notice must (x) describe the nature and basis of the
              claim or dispute; and (y) set forth the specific relief sought;
              and (z) set forth your name, address and contact information. If
              we intend to seek arbitration against you, we will send any notice
              of dispute to you at the contact information we have for you.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              The arbitration will be conducted before a neutral single
              arbitrator in the County of Allegheny in the Commonwealth of
              Pennsylvania, whose decision will be final and binding, and the
              arbitral proceedings will be governed by JAMS under its
              Comprehensive Arbitration Rules and Procedures (the “JAMS Rules”)
              as modified by these Terms and Conditions. The JAMS Rules are
              available at{" "}
              <Link href="#">
                <u>www.jamsadr.com</u>
              </Link>
              . All issues are for the arbitrator to decide, including the scope
              of this arbitration clause, but the arbitrator is bound by the
              terms of these Terms and Conditions. If you initiate arbitration,
              your arbitration fees will be limited to the filing fee set forth
              in the JAMS Rules. We will reimburse all other JAMS filing,
              administration and arbitrator fees paid by you, unless the
              arbitrator determines that the arbitration was frivolous or
              brought for an improper purpose, in which case the payment of all
              such fees shall be governed by the JAMS Rules. The arbitration
              will be conducted in the English language. Judgment on the award
              rendered by the arbitrator may be entered in any court of
              competent jurisdiction. For any claim where the potential award is
              reasonably likely to be $10,000 or less, either you or Duolingo
              may elect to have the dispute resolved through
              non-appearance-based arbitration.
            </p>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              To the fullest extent permitted by applicable law, YOU AND
              DUOLINGO EACH AGREE THAT ANY DISPUTE RESOLUTION PROCEEDING WILL BE
              CONDUCTED ONLY ON AN INDIVIDUAL BASIS AND NOT IN A CLASS,
              CONSOLIDATED OR REPRESENTATIVE ACTION. If for any reason a claim
              proceeds in court rather than in arbitration, YOU AND DUOLINGO
              EACH WAIVE ANY RIGHT TO A JURY TRIAL. If a court of competent
              jurisdiction finds the foregoing arbitration provisions invalid or
              inapplicable, you and Duolingo agree that all claims arising out
              of or related to these Terms and Conditions must be resolved
              exclusively by a state or federal court located in the County of
              Allegheny in the Commonwealth of Pennsylvania, and you and
              Duolingo each agree to submit to the exercise of personal
              jurisdiction of such courts for the purpose of litigating all such
              claims. Notwithstanding the above, you agree that Duolingo shall
              still be allowed to apply for and obtain injunctive remedies (or
              an equivalent type of urgent legal relief) in any jurisdiction.
            </p>
          </div>
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              23. <strong className="font-semibold">Language</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              24. <strong className="font-semibold">California Resident</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
          ...
          <div className="my-5">
            <h3 className="text-2xl mb-6">
              25. <strong className="font-semibold">Miscellaneous</strong>
            </h3>
            <p className="text-2xl text-gray-500 my-5 pl-5">
              These Terms and Conditions constitute the entire agreement between
              Duolingo and you concerning the subject matter hereof. In the
              ...
              remain in full force and effect. A waiver by Duolingo or you of
              ...
              subsequent breach thereof. Duolingo may assign its rights or
              ...
              the benefit of Duolingo and you, and Duolingos and your respective
...
const index = () => {
  return (
    ...
    //       </h3>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         Duolingo websites (“Websites”) and mobile applications (“Apps”) and
    //         related services (together with the Websites, the “Service”) are
    //         operated by Duolingo, Inc. (“Duolingo,” “us,” or “we”). Access and
    //         use of the Service is subject to the following Terms and Conditions
    //         of Service (“Terms and Conditions”). By accessing or using any part
    //         of the Service, you represent that you have read, understood, and
    //         agree to be bound by these Terms and Conditions including any future
    //         modifications. Duolingo may amend, update or change these Terms and
    ...
    //         services, including learning or practicing a language. Duolingo may,
    ...
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         Some of our Services have additional terms and conditions
    //         (“Additional Terms”). Where Additional Terms apply to a Service, we
    //         will make them available for you to read through your use of that
    ...
    //           perform any such translations or create any such courses in
    //           accordance with your own schedule and using your own facilities
    //           and resources. You are not required to become a Course Contributor
    //           and you may cease your activities as a Course Contributor at any
    //           time. You acknowledge that you do not desire and will not receive
    //           compensation for your activities as a Course Contributor or for
    //           our use of any Course Contributor Materials (as defined below) you
    //           submit. Any translation of an existing Duolingo course you submit
    //           or have submitted and any new language course you submit or have
    //           submitted as a Course Contributor (collectively, “Course
    //           Contributor Materials”) are owned by you (subject of course to us
    //           retaining ownership of the existing Duolingo course you
    //           translated).
    //         </p>
    //         <small>
    //           <i>
    ...
    //           data, text, photographs, audio clips, audiovisual works,
    //           translations, flashcards, Course Contributor Material, or other
    //           materials on the Services (collectively, “Content”), be $10,000 or
    //           less, either you or Duolingo may elect to have the dispute
    //           resolved through non-appearance-based arbitration. you hereby
    //           grant to Duolingo a full- paid, royalty free, perpetual,
    //           irrevocable, worldwide, nonexclusive, transferable, and
    //           sublicensable license to use, reproduce, copy, adapt, modify,
    //           merge, distribute, publicly display, create derivative works from,
    //           incorporate such Content into other works; sublicense through
    //           multiple tiers the Content, and acknowledge that this license
    //           cannot be terminated by you once your Content is submitted to the
    //           Services. You represent that you own or have secured all legal
    //           rights necessary for the Content submitted by you to be used by
    //           you, Duolingo, and others as described and otherwise contemplated
    //           in these Terms and Conditions. You understand that other users
    //           will have access to the Content and that neither they or Duolingo
    //           have any obligation to you or anyone else to maintain the
    ...
    //         laws of, operating from, or otherwise ordinarily resident in a
    //         country or territory that is the target or comprehensive U.S.
    //         economic or trade sanctions (i.e., an embargo) or (2) identified on
    //         a list of prohibited or restricted persons, such as the U.S.
    //         Treasury Department’s List of Specially Designated Nationals and
    //         Blocked Persons, or (3) otherwise the target of U.S. sanctions.
    //       </p>
    //     </div>
    ...
    //         proprietary rights); or (ii) in Duolingo’s sole judgment, is
    //         objectionable or which restricts or inhibits any other person from
    //         using the Service or which may expose Duolingo or its users to any
    //         harm or liability of any kind.
    //       </p>
    //     </div>
    //     <div className="my-5">
    //       <h3 className="text-2xl mb-6">
    ...
    //         translate any App or any part thereof. Duolingo and its licensors
    ...
    //         corrections thereto. The following terms and conditions apply to you
    //         only if you are using the Apps from the Apple App Store. To the
    //         extent the other terms and conditions of these Terms and Conditions
    ...
    //         respect to Apps from the Apple App Store. You acknowledge and agree
    //         that these Terms and Conditions are solely between you and Duolingo,
    //         not Apple, and that Apple has no responsibility for the Apps or
    //         content thereof. Your use of any App must comply with the App Store
    //         Terms of Service. You acknowledge that Apple has no obligation
    //         whatsoever to furnish any maintenance and support services with
    //         respect to the Apps. In the event of any failure of any App to
    //         conform to any applicable warranty, you may notify Apple, and Apple
    //         will refund the purchase price, if any, for the App to you; to the
    ...
    //         of you or any third party relating to the Apps or your possession
    ...
    //         acknowledge that, in the event of any third-party claim that any App
    ...
    //         required by these Terms and Conditions. You must comply with
    //         applicable third party terms of agreement when using any App. You
    //         and Duolingo acknowledge and agree that Apple, and Apple’s
    ...
    //         upon your acceptance of these Terms and Conditions, Apple will have
    ...
    //         subscription until you terminate it as set forth below. After your
    //         initial subscription period, and again after any subsequent
    //         subscription period, your subscription will automatically renew for
    //         an additional equivalent period. If you do not wish your
    //         subscription to renew automatically, or if you want to change or
    //         terminate your subscription, you will need to log in to your
    //         Duolingo account and follow instructions to terminate or change your
    //         subscription, even if you have deleted your account.
    //       </p>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         In the Service, you may purchase, with “real world” money, a
    //         limited, personal, non-transferable, non-sublicensable, revocable
    //         license to use (a) “virtual currency,” including but not limited to
    //         virtual gems, solely for use in the Service, and (b) “virtual in-app
    //         items” (together with “virtual currency,” “Virtual Items”). You are
    //         allowed to purchase Virtual Items through the Service, and not in
    //         any other way.
    //       </p>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         Duolingo may manage, regulate, control, modify, or eliminate Virtual
    //         Items at any time, with or without notice. Duolingo may update the
    //         pricing of Virtual Items at any time in its sole discretion, and may
    //         add new Virtual Items for additional fees. Duolingo shall have no
    //         liability to you or any third party in the event that Duolingo
    //         exercises any such rights.
    //       </p>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         The transfer of Virtual Items is prohibited except where expressly
    //         authorized in the Service. Other than as expressly authorized in the
    //         Service, you shall not sell, redeem or otherwise transfer Virtual
    //         Items to any person or entity, including but not limited to Company,
    ...
    //         anyone using a Duolingo account registered to you. Duolingo may
    //         revise the pricing for the goods and services offered through the
    //         Service at any time. All information that you provide in connection
    ...
    //       </h3>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         All financial transactions made in connection with the Service will
    //         be processed by a third party in accordance with their respective
    //         terms of use, privacy policy, and/or any applicable payment terms
    //         and conditions. We encourage you to learn about the practices of
    //         such third party. In no event will Duolingo be responsible for the
    //         actions or inactions of any third party payment processor,
    //         including, but not limited to, system downtime or payment service
    //         outages.
    //       </p>
    //     </div>
    //     <div className="my-5">
    ...
    //         voluntarily, you understand and agree that you will receive no
    //         refund or exchange of any kind, including for any unused virtual
    //         currency or other Virtual Item, any Content or data associated with
    ...
    //         website, service, or content from Duolingo, you understand that
    ...
    //         Duolingo shall not be responsible or liable, directly or indirectly,
    ...
    //         types and extent of advertising by Duolingo on the Service are
    //         subject to change. In consideration for Duolingo granting you access
    //         to and use of the Service, you agree that Duolingo and its third
    ...
    //         THE SERVICE, INCLUDING ALL IMAGES, AUDIO FILES AND OTHER CONTENT
    //         THEREIN, AND ANY OTHER INFORMATION, PROPERTY AND RIGHTS GRANTED OR
    //         PROVIDED TO YOU BY DUOLINGO ARE PROVIDED TO YOU ON AN “AS IS” BASIS.
    //         DUOLINGO AND ITS SUPPLIERS MAKE NO REPRESENTATIONS OR WARRANTIES OF
    ...
    //         DUOLINGO BE LIABLE TO YOU OR ANY THIRD PARTY CLAIMING THROUGH YOU
    //         (WHETHER BASED IN CONTRACT, TORT, STRICT LIABILITY OR OTHER THEORY)
    ...
    //         INACCURATE RESULTS, LOSS OF PROFITS, BUSINESS INTERRUPTION, OR
    //         DAMAGES STEMMING FROM LOSS OR CORRUPTION OF DATA OR DATA BEING
    //         RENDERED INACCURATE, THE COST OF RECOVERING ANY DATA, THE COST OF
    //         SUBSTITUTE SERVICES OR CLAIMS BY THIRD PARTIES FOR ANY DAMAGE TO
    //         COMPUTERS, SOFTWARE, MODEMS, TELEPHONES OR OTHER PROPERTY, EVEN IF
    //         DUOLINGO HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. TO THE
    //         MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, DUOLINGO’S LIABILITY TO
    ...
    //         THE AMOUNT PAID, IF ANY, BY YOU TO DUOLINGO FOR THE SERVICE IN THE
    //         12 MONTHS PRIOR TO THE INITIAL ACTION GIVING RISE TO LIABILITY. THIS
    ...
    //         immediately at any time, for any reason, and at such time you will
    //         have no further right to use the Service. You may terminate your
    //         Duolingo account at any time by following the instructions available
    //         through the Service. The provisions of these Terms and Conditions
    //         relating to the protection and enforcement of Duolingo’s proprietary
    ...
    //         proprietary property of Duolingo or its licensors. No Service
    ...
    //         Duolingo, all data, information and materials generated from your
    ...
    //         by Duolingo, and you shall not have any right to use such Activity
    //         Materials except as expressly authorized by these Terms and
    //         Conditions. Activity Materials will not include Translation
    //         Materials. By using the Service, you hereby assign to Duolingo any
    ...
    //         All rights of Duolingo or its licensors that are not expressly
    //         granted in these Terms and Conditions are reserved to Duolingo and
    //         its licensors.
    //       </p>
    //     </div>
    //     <div className="my-5">
    ...
    //         marks of Duolingo or their respective owners, and certain of them
    ...
    //         right or license to reproduce or otherwise use the Duolingo name or
    //         any Duolingo or third-party trademarks, service marks, graphics or
    //         logos.
    //       </p>
    //     </div>
    //     <div className="my-5">
    ...
    //     <div className="my-5">
    //       <h3 className="text-2xl mb-6">
    //         20. <strong className="font-semibold">Promotion Code Terms</strong>
    //       </h3>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         “Duolingo” and all other trademarks, service marks, graphics and
    //         logos used in connection with the Service are trademarks or service
    ...
    //         </small>
    //         <p className="py-5">
    //           Each Promotional Code provides access to Super Duolingo: A. at the
    //           price advertised; and B. beginning the moment that you confirm
    //           your acceptance of the Promotional Code by submitting valid
    //           payment details that are accepted by Duolingo (the “Promotional
    //           Period”); and C. in some circumstances, subject to an overall
    //           limit of allowed redemptions of that Promotional Code. By
    //           submitting your payment details, you (i) confirm your acceptance
    //           of the Promotional Code advertised; (ii) accept and agree to these
    //           Promotional Code Terms; and (iii) acknowledge and agree to the
    ...
    //         </small>
    //         <p className="py-5">
    //           In order to be eligible for a Promotional Code, users must satisfy
    //           all of the following conditions (each an “Eligible User”): A.
    //           Unless you are subscribing to a Promotional Code that is
    //           advertised as available to current subscribers, you must not be a
    //           current subscriber. B. Provide Duolingo with a valid and current
    //           payment method that is approved by Duolingo. C. Additional
    //           eligibility requirements (if any) as advertised from time-to-time
    //           in connection with a Promotional Code. Eligible Users may accept a
    //           Promotional Code once - previous users may not redeem the offer
    //           again.
    //         </p>
    //         <small>
    //           <i>
    ...
    //           A Promotional Code must be accepted before the applicable
    //           expiration date advertised, if any. Except where prohibited by
    //           law, Duolingo reserves the right to modify, suspend or terminate a
    //           Promotional Code at any time and for any reason, in which case we
    //           will not honour subsequent Promotional Code enrollments.
    //         </p>
    //         <small>
    //           <i>
    //             <u>Duration and cancellation.</u>
    ...
    //           charged for the then-current subscription price. If you cancel
    //           during the Promotional Period, you will lose access to Super
    //           Duolingo and you understand and agree that you will receive no
    //           refund or exchange of any kind, including for any unused virtual
    //           currency or other Virtual Item, any Content or data associated
    //           with your use of the Service, or for anything else.
    //         </p>
    ...
    //         </small>
    //         <p className="py-5">
    //           By using the Promotional Code, you understand and agree that your
    //           anonymized aggregated data may be shared by Duolingo with the
    //           partner or provider who made the Promotional Code available to
    //           you.
    //         </p>
    //       </div>
    //     </div>
    ...
    //         Duolingo pursuant to the Digital Millennium Copyright Act by
    //         providing us with the following information in writing:
    //       </p>
    //       <div className="text-2xl text-gray-500 my-5 pl-5">
    //         <li>
    ...
    //           copyright owner or are authorized to act on the copyright owners
    //           behalf.
    //         </li>
    //       </div>
    //       <h3 className="text-2xl text-gray-500 my-5 pl-5">
    ...
    //       <h3 className="text-2xl text-gray-500 my-5 pl-5">
    //         For clarity, only copyright infringement notices should go to our
    //         Copyright Agent. You acknowledge that if you fail to comply with all
    //         of the requirements of this section your notice may not be valid.
    //       </h3>
    //       <h3 className="text-2xl text-gray-500 my-5 pl-5">
    ...
    //         the copyright owner, the copyright owners agent, or pursuant to the
    //         law, to post and use such content, you may submit a counter-notice
    ...
    //           court in the judicial district in which you reside, or if you
    //           reside outside of the United States, then of the federal court in
    //           Pittsburgh, Pennsylvania, and a statement that you will accept
    ...
    //       <h3 className="text-2xl text-gray-500 my-5 pl-5">
    //         After we send out the counter-notification, the claimant must then
    //         notify us within 10 days that he or she has filed an action seeking
    //         a court order to restrain you from engaging in infringing activity
    //         relating to the content that was removed or disabled. If we receive
    //         such notification, we will be unable to restore the material. If we
    ...
    //         construed under the laws of the Commonwealth of Pennsylvania, United
    //         States of America, excluding the conflict of law provisions of that
    //         or any other jurisdiction, regardless of your country of origin or
    //         where you access the Service. ANY DISPUTE OR CLAIM RELATING IN ANY
    //         WAY TO THESE TERMS AND CONDITIONS OR THE SERVICE WILL BE RESOLVED BY
    //         BINDING ARBITRATION, RATHER THAN IN COURT, except for Duolingo’s
    ...
    //         If you do not want to arbitrate disputes with Duolingo and you are
    //         an individual, you may opt out of this arbitration agreement by
    //         sending an email to legal@duolingo.com within 30 days of the day you
    //         first access or use the Service.
    //       </p>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         If you intend to seek arbitration you must first send written notice
    //         to Duolingo’s Administration Office of your intent to arbitrate
    //         (“Notice”). The Notice to Duolingo should be sent by any of the
    //         following means: (i) electronic mail to legal@duolingo.com; or (ii)
    //         sending the Notice by U.S. Postal Service certified mail to
    //         Duolingo, Inc., Attention: Legal, 5900 Penn Ave; Pittsburgh, PA
    //         15206. The Notice must (x) describe the nature and basis of the
    //         claim or dispute; and (y) set forth the specific relief sought; and
    //         (z) set forth your name, address and contact information. If we
    ...
    //         whose decision will be final and binding, and the arbitral
    //         proceedings will be governed by JAMS under its Comprehensive
    //         Arbitration Rules and Procedures (the “JAMS Rules”) as modified by
    //         these Terms and Conditions. The JAMS Rules are available at{" "}
    //         <Link href="#">
    //           <u>www.jamsadr.com</u>
    //         </Link>
    //         . All issues are for the arbitrator to decide, including the scope
    //         of this arbitration clause, but the arbitrator is bound by the terms
    //         of these Terms and Conditions. If you initiate arbitration, your
    //         arbitration fees will be limited to the filing fee set forth in the
    //         JAMS Rules. We will reimburse all other JAMS filing, administration
    //         and arbitrator fees paid by you, unless the arbitrator determines
    //         that the arbitration was frivolous or brought for an improper
    //         purpose, in which case the payment of all such fees shall be
    //         governed by the JAMS Rules. The arbitration will be conducted in the
    //         English language. Judgment on the award rendered by the arbitrator
    //         may be entered in any court of competent jurisdiction. For any claim
    //         where the potential award is reasonably likely to be $10,000 or
    //         less, either you or Duolingo may elect to have the dispute resolved
    //         through non-appearance-based arbitration.
    //       </p>
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         To the fullest extent permitted by applicable law, YOU AND DUOLINGO
    ...
    //         rather than in arbitration, YOU AND DUOLINGO EACH WAIVE ANY RIGHT TO
    ...
    //         Duolingo agree that all claims arising out of or related to these
    //         Terms and Conditions must be resolved exclusively by a state or
    //         federal court located in the County of Allegheny in the Commonwealth
    //         of Pennsylvania, and you and Duolingo each agree to submit to the
    //         exercise of personal jurisdiction of such courts for the purpose of
    //         litigating all such claims. Notwithstanding the above, you agree
    //         that Duolingo shall still be allowed to apply for and obtain
    ...
    //       <p className="text-2xl text-gray-500 my-5 pl-5">
    //         These Terms and Conditions constitute the entire agreement between
    //         Duolingo and you concerning the subject matter hereof. In the event
    ...
    //         in full force and effect. A waiver by Duolingo or you of any
