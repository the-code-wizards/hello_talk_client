...
>>>>>>> 0cb281bc0d8a7363e3953b720bdd8910626b50e0
          ...
          <div className="my-5">
            ...
            <div className="text-2xl text-gray-500 pl-5">
              ...
              <p className="py-5">
                ...
                transaction information if you choose to pay for Duolingo
                services.
              </p>
              <small>
                <i>
              ...
              <p className="py-5">
                ...
                Duolingo with a feature called Duolingo Tutors. In this case,
                you may opt into sending text, audio, image, or video files to
                this tutor and sharing personal data about yourself. Duolingo
                stores these messages and files for you until you close your
                Duolingo account. Duolingo uses this data to help improve the
                quality of your interactions with Duolingo Tutors and for
                internal research purposes.
              </p>
              <p className="py-5">
                By default Duolingo will only share your username, profile
                image, and recent Duolingo activity with your tutor. This
                ...
                Duolingo profile information, such as your name, email address
              ...
              <p className="py-5">
                ...
                way. Any audio you agree to send to Duolingo is anonymized when
              ...
              <p className="py-5">
                ...
                From the collected data, Duolingo and/or its trusted
                third-parties may extract biometric signals for the use of
                identity verification. While using the Duolingo English Test,
              ...
              <p className="py-5">
                Additionally, Duolingo will be able to note if any peripherals
              ...
              <p className="py-5">
                ...
                Duolingo can verify that this number does belong to you. Once
                ...
                is stored in your Duolingo user profile.
              </p>
              <p className="py-5">
                ...
                actual phone number and can be used only by Duolingo to uniquely
                identify the number. It’s a bit like a fingerprint. This hashing
                process securely strips away the real phone number which means
                that we don’t store any of your contacts’ phone numbers and so
                we cannot use them to contact individuals or share them with
                anyone else.
              </p>
              <p className="py-5">
                We then try to match your contacts’ hashes with the hashed phone
                numbers that other Duolingo learners have chosen to upload to
          ...
          <div className="my-5 ">
            ...
            <div className="text-2xl text-gray-500 pl-5">
              <p className="py-5">
                ...
                Duolingo teaching methodology by reinforcing the learning
              ...
              <p className="py-5">
                ...
                offered by Duolingo if you affirmatively consent to receive such
                communications.
              </p>
              <p className="py-5">
                When you register with Duolingo, some of your information is
                made public and available at various locations including
                duolingo.com/profile/your-username and
                duolingo.com/users/your-username. This will include the data
                from your Duolingo Profile and Account (Name, Location, Bio,
                Username, User ID, Profile picture and Duolingo Plus membership
                ...
                or to people you have shared a link with. Your Duolingo account
              ...
              <p className="py-5">
                ...
                (which can be deleted by you). Duolingo uses this information to
                provide you with support, to send you essential notifications,
                to enforce our terms, conditions and policies, to communicate
                with you, to administer the Services, and for internal
                operations, including troubleshooting, data analysis, testing,
                research, statistical, and survey purposes. Duolingo’s Terms and
                Conditions provide the contractual lawful basis for these
              ...
              <div className="pl-5">
                ...
                <li>
                  ...
                  identity Duolingo has validated) is the same person who took
              ...
              <p className="py-5">
                ...
                provide your child’s age. This information is kept anonymously
                for research purposes and not tied to your personal data in any
                way. You can then choose to enable speaking exercises. Speech
                data is stored on your phone and uses Apple’s speech recognition
                service to convert your voice into text. No speech data is
                shared with Duolingo. As a parent you also have the option of
                providing your email address so that Duolingo may send you
                information about product updates and to ask you about
              ...
              <p className="py-5">
                Duolingo Math is a separate app to the Duolingo Language app,
                and is intended for use by both children and adults. When you
                first open the app, you will have the option to (1) log in with
                an existing Duolingo account, or (2) start using the app
                immediately without an account. Logging in with your Duolingo
              ...
              <p className="py-5">
                Your Duolingo Math progress data is stored on your phone.
                Deleting the Duolingo Math app will delete your progress.
                Duolingo Math uses Google ML Kit for handwriting recognition in
          ...
          <div className="my-5">
            ...
            <div className="text-2xl text-gray-500 my-5 pl-5">
              ...
              <p className="py-5">
                ...
                to the provision of services to Duolingo.
              </p>
              <p className="py-5">
              ...
              <p className="py-5">
                Duolingo will share the complete and accurate results of
                Duolingo English Tests with such institutions, including
                ...
                results will be used by Duolingo and its partners to improve the
                examination and for research and analysis. We will not share
              ...
              <p className="py-5">
                ...
                Duolingo that are related to the Service, were to change, your
              ...
              <p className="py-5">
                Duolingo will share aggregate or anonymous data collected
            ...
            <div className="text-2xl text-gray-500 my-5 pl-5">
              ...
              <div className="pl-5">
                ...
                <li>
                  ...
                  format that can be transferred electronically to a third
                  party.
                </li>
                <li>
              ...
              <p className="text-2xl text-gray-500 my-5 pl-5">
                ...
                by Duolingo and shared with third parties in any manner.
                Information associated with the Duolingo English Test, including
                examination results and your Testing Video, will be collectively
                deleted from your Duolingo account after five years have passed
                from the date you upload your test, but anonymized examination
                data, including your examination results and Testing Video, will
                be kept indefinitely by Duolingo to improve the examination and
          ...
          <div className="my-5">
            ...
            <div className="text-2xl text-gray-500 my-5 pl-5">
              <p className="py-5">
                ...
                Duolingo would like to inform you that anytime you click on
          ...
          <div className="my-5">
            ...
            <div className="text-2xl text-gray-500 my-5 pl-5">
              ...
              <p className="py-5">
                ...
                about Duolingo’s privacy and information practices regarding
                child users, including what personal data we collect and how we
                use, share, and protect that personal data. The email also
                explains how parents can request that Duolingo access, change or
              ...
              <p className="text-2xl text-gray-500 my-5 pl-5">
                ...
                (COPPA), Duolingo only collects personal information from
          ...
          <div className="my-5">
            ...
            <p className="text-2xl text-gray-500 my-5 pl-5">
              Duolingo has implemented administrative and technical safeguards
              ...
              Photo, access credentials, and Duolingo English Test results.
