                ...
                <div className="navbar-start ">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="font-featherBold menu menu-compact dropdown-content mt-3 p-2 shadow bg-green-300 rounded-box w-52  font-medium">
                            ...
                            <li><Link href='/blogs'>Learn</Link></li>
                ...
                <div className="navbar-end hidden lg:flex ">
                    <ul className="font-featherBold menu menu-horizontal px-1 text-white font-medium">
                        <li><Link href='/blogs'>Blog</Link></li>
                            ...
                            <li><Link href='/contact'>Contact Us</Link></li>
                        {user ? 
                             <li> <button className=" bg-[#58cc02] border-[#61B800] border-t-[2px] border-b-[5px] border-l-[2px] border-r-[2px] py-[8px] px-5 rounded-xl text-white font-bold text-[14px] focus:border-b-[2px] hover:bg-[#61E002]" onClick={logout}>Log Out</button>
                            </li>                           
                            :
