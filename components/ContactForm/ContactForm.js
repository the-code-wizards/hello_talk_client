...
import contactGif from '../../resourses/lottieJson/contact.json'
    ...
    return (
        ...
        <div className="flex flex-col justify-between">
            <div className="space-y-2">
                <h2 className="text-3xl font-bold leading-tight lg:text-5xl">Lets Contact <br /> with Us!</h2>
                <div className="text-gray-600">Full free to Message</div>
            </div>
        ...
        <form novalidate="" className="space-y-6 ng-untouched ng-pristine ng-valid">
            ...
            <div>
                ...
                <textarea id="message" rows="3" className="w-full p-3 rounded bg-gray-100" spellcheck="false"></textarea>
            </div>
