    ...
    fetch('https://hello-talk-webserver.vercel.app/postcomment', {
      ...
      .then((res) => {
        ...
        if (res.acknowledged === true) {
          swal('Your questions is posted!', 'Possible reponse is near !', 'success');
          form.reset();
        }
      });
  };
      ...
      <div className=" bg-white p-3 rounded-2xl mt-8 border border-inherit">
        ...
        <div className="p-3">
          <p className="text-[16px]">
            How to find a stylus pen which is compactable with myHp Pavillion ×360 14m-dw1xxx
            laptop?I searched everywhere i am not able
          </p>
        </div>
        <div className="divider my-[-2px] "></div>
        <div className="flex justify-between">
          <div className="flex justify-center">
            <button onClick={handleLike} className="flex  hover:bg-[#F0F2F5] px-2 items-center ">
              <AiTwotoneLike />
              <span className="ml-1">Like</span>
            </button>
            <div className="flex ml-4 justify-center items-center hover:bg-[#F0F2F5] px-2">
              <button onClick={commentRender}>
                <BiCommentDetail />
              </button>
        ...
        <div className={`px-8 pt-8 ${commentView}`}>
          ...
          {comments.map((commentData) => (
            <SingleComment key={commentData._id} comment={commentData}></SingleComment>
          ))}
          ...
          <div className="grid grid-cols-12">
            ...
            <input
              ...
              name=""
              id=""
              className="input input-bordered rounded-full input-primary  ml-2 h-[36px] w-full  bg-[#F0F2F5] px-2 col-span-11"
                ...
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                  ...
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                      <h3 className="text-xl font-semibold text-center">Write your Comment</h3>
                      <button
                    ...
                    <form onSubmit={handleComment}>
                      <div className="relative p-6 flex-auto ">
                        <textarea
                          name="textarea"
                          className="textarea w-[600px] input-bordered "
                          placeholder="Your Comment"
                        ></textarea>
                      </div>
                      {/*footer*/}
                      <div className="flex items-center justify-end  border-t border-solid border-slate-200 rounded-b">
                        <button className="btn btn-md btn-ghost mr-2" type="submit">
                          Post
                        </button>
                      </div>
                    </form>
