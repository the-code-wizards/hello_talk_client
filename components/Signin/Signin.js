      ...
      <div className="min-h-screen" style={{ backgroundImage: `url("back.svg")` }}>
        <div className="flex justify-between items-center p-[30px]">
          ...
          <Link href="/signup">
            <button
              type="button"
              className="bg-[#fff] border-[#CECECE] border-t-[2px] border-b-[5px] border-l-[2px] border-r-[2px] py-[8px] px-[18px] rounded-xl text-[#1cb0f6] font-bold text-[14px] focus:border-b-[2px] hover:bg-[#ece7e7]"
            >
              SIGN UP
            </button>
          </Link>
        ...
        <div className=" my-auto pb-8">
          <div className="lg:md:px-[23%] px-[5%]">
            <div className="border-[2px] rounded-xl w-full bg-[#fff]">
              <h2 className="lg:md:text-2xl text-lg text-center lg:md:mt-4 mt-2 text-[#3C3C3C] font-featherBold">
                Log in
              </h2>
              <div className="mt-[50px] my-auto ">
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center">
                  ...
                  <button
                    className="mt-[15px] bg-[#1FC2FF] border-[#1AA8EB] border-t-[2px] border-b-[5px] border-l-[2px] border-r-[2px] py-[10px] lg:md:w-[40%] w-[50%] rounded-xl text-[#fff] font-bold lg:md:text-[15px] text-[12px] focus:border-b-[2px]"
                    type="submit"
                  >
                    LOG IN
                  </button>
                ...
                <div className="mt-4 text-center pb-4">
                  <Link
                    href="/terms"
                    className="cursor-pointer lg:md:font-bold text-center ml-3 text-medium text-[15px]"
                  >
                    Terms and condition
                  </Link>
                  <Link
